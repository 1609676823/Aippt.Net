...
{
    /// <summary>
    /// Markdown解析响应类，包含返回码、提示信息和解析后的Markdown文本
    /// Markdown parsing response class, containing return code, prompt information, and parsed Markdown text
    /// </summary>
    public class MarkdownParseResponse
    {
        ...
        public string? RealJsonstring
        {
            ...
            set
            {
                ...
                try
                {
                    DeserializeMarkdownParseResponse(value!);
                }
                catch (Exception)
                {
        ...
        public virtual void DeserializeMarkdownParseResponse(string json)
        {

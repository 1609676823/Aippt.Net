...
{
    /// <summary>
    /// 作品还原响应类，包含返回码、数据和提示信息
    /// Work revert response class, containing return code, data, and prompt information
    /// </summary>
    public class DesignRevertResponse
    {
        /// <summary>
        /// 返回码，0表示成功，非0表示异常
        ...
        // 为了与 DesignDeleteResponse 保持一致，这里也用 object?，
        ...
        public string? RealJsonstring
        {
            ...
            set
            {
                ...
                try
                {
                    DeserializeDesignRevertResponse(value!);
                }
                catch (Exception)
                {
                    // 异常处理，可根据需要记录日志
        ...
        public virtual void DeserializeDesignRevertResponse(string json)
        {
